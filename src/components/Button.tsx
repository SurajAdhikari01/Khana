...
const Button = ({ onClick, text, variant }) => {
  const buttonStyles = {
    ...
    cancel:
      "align-middle select-none font-sans font-bold py-6 px-8 text-center uppercase transition-all bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-full",
